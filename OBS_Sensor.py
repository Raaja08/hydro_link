...
# Display title on the left, logo on the right
st.markdown(f"""
...
if selected_file:
    ...
    metadata_df['sensor_id'] = metadata_df['sensor_id'].astype(str)  # Ensure string type
    ...
    sensor_name = sensor_id  # fallback if you don't have a separate 'sensor_name' column
    ...
    # Remove obvious outliers in pressure whihc are below 1000 
    ...
    # ✅ Add a converted column for display
    ...
    #safe_min_date = datetime(2023, 1, 1)
