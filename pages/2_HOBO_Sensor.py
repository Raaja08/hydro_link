...
if selected_file:
    ...
    sensor_id = selected_file.split(".")[0]  # e.g., hobo_s3_2023
    ...
    selected_params = [p for p in AVAILABLE_PARAMS.keys() if p in df.columns and st.sidebar.checkbox(AVAILABLE_PARAMS[p], p == 'water_level')]
